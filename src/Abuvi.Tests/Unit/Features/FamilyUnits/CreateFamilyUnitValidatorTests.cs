...
public class CreateFamilyUnitValidatorTests
{
    private readonly CreateFamilyUnitValidator _validator = new();
    ...
    {
        // Arrange
        var request = new CreateFamilyUnitRequest(name!);
    ...
    {
        // Arrange
        var request = new CreateFamilyUnitRequest(new string('A', 201));
