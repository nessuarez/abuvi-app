...
namespace Abuvi.API.Migrations
{
    ...
    [Migration("20260825093234_AddCampAlbumsThemesAndSocial")]
    partial class AddCampAlbumsThemesAndSocial
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Abuvi.API.Features.Camps.AccommodationAssignment", b =>
                {
                    ...
                    b.HasIndex("ProposalId", "AccommodationId", "UnitIndex")
                        .IsUnique()
            ...
            modelBuilder.Entity("Abuvi.API.Features.Camps.AccommodationTypeMedia", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AccommodationType")
                        .HasDatabaseName("ix_accommodation_type_media_type");

                    b.HasIndex("AccommodationType", "IsPrimary")
                        .HasDatabaseName("ix_accommodation_type_media_type_primary");

                    b.ToTable("accommodation_type_media", (string)null);
                });
                    ...
                    b.ToTable("camp_edition_accommodations", null, t =>
                        {
                            ...
                            t.HasCheckConstraint("CK_CampEditionAccommodations_Quantity", "quantity > 0");

                            t.HasCheckConstraint("CK_CampEditionAccommodations_SortOrder", "sort_order >= 0");
                        });
                });

            modelBuilder.Entity("Abuvi.API.Features.Camps.CampEditionAttendance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("CampEditionId", "UserId", "FamilyMemberId")
                        .IsUnique()
                        .HasDatabaseName("ux_camp_edition_attendances_edition_user_member");

                    b.ToTable("camp_edition_attendances", (string)null);
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaComments.MediaComment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaComments.MediaCommentReport", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("MediaCommentId")
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("MediaCommentId", "ReportedByUserId")
                        .IsUnique()
                        .HasDatabaseName("ux_media_comment_reports_comment_reporter");

                    b.ToTable("media_comment_reports", (string)null);
                });

            modelBuilder.Entity("Abuvi.API.Features.MediaDating.MediaItemYearProposal", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid?>("ProposedCampEditionId")
                        .HasColumnType("uuid")
                        .HasColumnName("proposed_camp_edition_id");

                    b.Property<int>("ProposedYear")
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("ProposedCampEditionId");

                    b.HasIndex("MediaItemId", "ProposedByUserId")
                        .IsUnique()
                        .HasDatabaseName("ux_media_item_year_proposals_item_user");

                    b.ToTable("media_item_year_proposals", (string)null);
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaItems.MediaItem", b =>
                {
                    ...
                    b.HasIndex("AccommodationId", "IsPrimary")
                    ...
                    b.HasIndex("ZoneId", "IsPrimary")
                        .HasDatabaseName("ix_media_items_zone_primary");

                    b.HasIndex("CampEditionId", "IsApproved", "IsPublished")
                        .HasDatabaseName("ix_media_items_edition_approved_published");

                    b.ToTable("media_items", (string)null);
                });

            modelBuilder.Entity("Abuvi.API.Features.MediaSources.MediaSource", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ContributorContact")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)")
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaThemes.MediaItemTheme", b =>
                {
                    b.Property<Guid>("MediaItemId")
                        .HasColumnType("uuid")
                        .HasColumnName("media_item_id");

                    b.Property<Guid>("MediaThemeId")
                        .HasColumnType("uuid")
                        .HasColumnName("media_theme_id");
                    ...
                    b.HasKey("MediaItemId", "MediaThemeId");

                    b.HasIndex("MediaThemeId")
                        .HasDatabaseName("ix_media_item_themes_theme_id");

                    b.HasIndex("TaggedByUserId");

                    b.ToTable("media_item_themes", (string)null);
                });

            modelBuilder.Entity("Abuvi.API.Features.MediaThemes.MediaTheme", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("media_themes", (string)null);
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.Payment", b =>
                {
                    ...
                    b.Property<bool>("ConceptOverridden")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.Registration", b =>
                {
                    ...
                    b.Property<string>("AccommodationInternalNotes")
                        .HasMaxLength(4000)
                        .HasColumnType("character varying(4000)")
                    ...
                    b.Property<string>("DraftTargetStatus")
                        .HasMaxLength(30)
                        .HasColumnType("character varying(30)")
                        .HasColumnName("draft_target_status");
                    ...
                    b.Property<bool>("FamilyNotifiedOfDraft")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                    ...
                    b.Property<bool>("HasPendingUserAcknowledgement")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
                        .HasDefaultValue(false)
                        .HasColumnName("has_pending_user_acknowledgement");
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationAccommodationNeed", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("AccommodationFeatureId")
                        .HasColumnType("uuid")
                        .HasColumnName("accommodation_feature_id");
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationFriendLink", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("LinkedRegistrationId")
                        .HasColumnType("uuid")
                        .HasColumnName("linked_registration_id");
                    ...
                    b.HasIndex("RegistrationId", "LinkedRegistrationId")
                        .IsUnique()
                        .HasDatabaseName("IX_RegistrationFriendLinks_RegistrationId_LinkedId");

                    b.ToTable("registration_friend_links", null, t =>
                        {
                            t.HasCheckConstraint("CK_RegistrationFriendLinks_NoSelfLink", "registration_id <> linked_registration_id");
                        });
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationStatusHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("registration_status_history", (string)null);
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.Camps.CampEditionAttendance", b =>
                {
                    ...
                    b.HasOne("Abuvi.API.Features.Users.User", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaComments.MediaComment", b =>
                {
                    ...
                    b.HasOne("Abuvi.API.Features.MediaItems.MediaItem", "MediaItem")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaComments.MediaCommentReport", b =>
                {
                    b.HasOne("Abuvi.API.Features.MediaComments.MediaComment", "MediaComment")
                        .WithMany()
                        .HasForeignKey("MediaCommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Abuvi.API.Features.Users.User", "ReportedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaDating.MediaItemYearProposal", b =>
                {
                    ...
                    b.HasOne("Abuvi.API.Features.Users.User", "ProposedBy")
                        .WithMany()
                        .HasForeignKey("ProposedByUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Abuvi.API.Features.Camps.CampEdition", "ProposedCampEdition")
                        .WithMany()
                        .HasForeignKey("ProposedCampEditionId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("ProposedCampEdition");
                });
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaItems.MediaItem", b =>
                {
                    ...
                    b.HasOne("Abuvi.API.Features.MediaSources.MediaSource", "MediaSource")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaSources.MediaSource", b =>
                {
                    b.HasOne("Abuvi.API.Features.Users.User", "ContributorUser")
                        .WithMany()
                        .HasForeignKey("ContributorUserId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Abuvi.API.Features.Users.User", "RegisteredBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.MediaThemes.MediaItemTheme", b =>
                {
                    ...
                    b.HasOne("Abuvi.API.Features.MediaThemes.MediaTheme", "MediaTheme")
                        .WithMany("Items")
                        .HasForeignKey("MediaThemeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Abuvi.API.Features.Users.User", "TaggedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationAccommodationNeed", b =>
                {
                    b.HasOne("Abuvi.API.Features.Camps.AccommodationFeature", "AccommodationFeature")
                        .WithMany()
                        .HasForeignKey("AccommodationFeatureId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Abuvi.API.Features.Registrations.Registration", "Registration")
                        .WithMany("AccommodationNeeds")
                        .HasForeignKey("RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("AccommodationFeature");
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationFriendLink", b =>
                {
                    b.HasOne("Abuvi.API.Features.Registrations.Registration", "LinkedRegistration")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.RegistrationStatusHistory", b =>
                {
                    b.HasOne("Abuvi.API.Features.Users.User", "ChangedByUser")
                        .WithMany()
            ...
            modelBuilder.Entity("Abuvi.API.Features.Registrations.Registration", b =>
                {
                    b.Navigation("AccommodationNeeds");

                    b.Navigation("AccommodationPreferences");

                    b.Navigation("Extras");

                    b.Navigation("FriendLinks");
